...
Neste relatório são apresentadas, análises da escala com base em uma amostra de 2766 educadores do curso. As análises foram conduzidas através da linguagem de programação R usando os pacotes *car*, *psych* e *mirt*. 
...
table(!is.na(attitudesDf$scaleSum))
187/(187+2766)*100
...
for (i in c(14,19,28,29,32,33,34,35)) {
  fullScale[,i] <- recode(fullScale[,i], "1:2=0; 3:5=1")
}
...
* Sem fator 9, 13, 19,21,25,28,31,38
* Em dois fatores 14,23,36,37,39
* MR1  : 1,2,3,4,5,6,7,8,10,11,12,15,16,17,18,20,22,24,26,27,30
* MR2  : 29,32,33,34,35

#### Versão somente com itens com melhores cargas
```{r}
# Remove items with low loadings
shortScale  <- fullScale[, -c(9,13, 19,21,25,28,31,38)]
